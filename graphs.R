...
plot(firing$time, firing$id, xlim=c(1, 20), ylim=c(1, 500), main='Neuron Firings',
...
plot(vs$time, vs$vol, xlim=c(1, 20), ylim=c(-110, 25), main='Membrane Potential Evolution for Neuron 1',
...
plot(rs$time, rs$rec, xlim=c(1, 20), main='Recovery Variable Evolution for Neuron 1',
